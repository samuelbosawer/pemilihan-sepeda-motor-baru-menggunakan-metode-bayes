...
<?php
   ...
   $datas =mysqli_query($conn,"SELECT * FROM pendaftaran WHERE role = '2' ORDER BY id_pendaftaran DESC");
   $dealer = '';
  if(isset($_GET['name']))
  {
    $dealer = $_GET['name'];
   $datas =mysqli_query($conn,"SELECT * FROM pendaftaran WHERE role = '2' AND dealer = '$dealer' ORDER BY id_pendaftaran DESC");
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dealer">Dealer</a></li>
