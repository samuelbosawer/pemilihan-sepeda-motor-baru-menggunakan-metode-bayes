...
function add_motor($data,$table,$file)
{
  ...
  $pathFoto = "../assets/img/data/".$namaBaru;
    ...
    if(move_uploaded_file($tmp_file_gambar, $pathFoto) ){
      ...
      $query = "INSERT INTO `$table` (`id_motor`, `jenis_motor`, `class`, `alternatif`, `bb_pengguna`, `bb_pengguna_batas`, `k_maksimal`, `k_tengki`,`tinggi_badan`,`tinggi_badan_batas`,`jarak_awal`,`jarak_akhir`,`kondisi_jalan`,`harga`,`stok`,`gambar`)  VALUES ('$id_motor', '$jenis_motor', '$class', '$alternatif', '$bb_pengguna', '$bb_pengguna_batas', '$k_maksimal','$k_tengki','$tinggi_badan','$tinggi_badan_batas','$jarak_awal','$jarak_akhir','$kondisi_jalan','$harga', '$stok','$gambar')";
